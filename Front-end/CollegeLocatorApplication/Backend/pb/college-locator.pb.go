...
var file_college_locator_proto_rawDesc = []byte{
	...
	0x32, 0x9c, 0x01, 0x0a, 0x15, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x67, 0x65, 0x4c, 0x6f, 0x63, 0x61,
	0x74, 0x6f, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x28, 0x0a, 0x07, 0x49, 0x6e,
	...
	0x73, 0x65, 0x30, 0x01, 0x12, 0x2b, 0x0a, 0x06, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x12, 0x0e,
	...
	0x01, 0x12, 0x2c, 0x0a, 0x07, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x0f, 0x2e, 0x44,
	...
	0x3f, 0x0a, 0x35, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x67, 0x65, 0x6c, 0x6f,
	0x63, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x67, 0x65, 0x6c, 0x6f, 0x63,
	0x61, 0x74, 0x6f, 0x72, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e,
...
type CollegeLocatorServiceClient interface {
	InitApp(ctx context.Context, in *InitRequest, opts ...grpc.CallOption) (CollegeLocatorService_InitAppClient, error)
...
func (c *collegeLocatorServiceClient) InitApp(ctx context.Context, in *InitRequest, opts ...grpc.CallOption) (CollegeLocatorService_InitAppClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CollegeLocatorService_serviceDesc.Streams[0], "/CollegeLocatorService/InitApp", opts...)
	if err != nil {
		return nil, err
	}
	x := &collegeLocatorServiceInitAppClient{stream}
...
type CollegeLocatorService_InitAppClient interface {
	Recv() (*InitResponse, error)
	grpc.ClientStream
}

type collegeLocatorServiceInitAppClient struct {
	grpc.ClientStream
}

func (x *collegeLocatorServiceInitAppClient) Recv() (*InitResponse, error) {
	m := new(InitResponse)
...
func (c *collegeLocatorServiceClient) Search(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (CollegeLocatorService_SearchClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CollegeLocatorService_serviceDesc.Streams[1], "/CollegeLocatorService/Search", opts...)
	if err != nil {
		return nil, err
	}
...
type CollegeLocatorServiceServer interface {
	InitApp(*InitRequest, CollegeLocatorService_InitAppServer) error
...
func (*UnimplementedCollegeLocatorServiceServer) InitApp(*InitRequest, CollegeLocatorService_InitAppServer) error {
	return status.Errorf(codes.Unimplemented, "method InitApp not implemented")
}
...
func _CollegeLocatorService_InitApp_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(InitRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CollegeLocatorServiceServer).InitApp(m, &collegeLocatorServiceInitAppServer{stream})
}

type CollegeLocatorService_InitAppServer interface {
	Send(*InitResponse) error
	grpc.ServerStream
}

type collegeLocatorServiceInitAppServer struct {
	grpc.ServerStream
}

func (x *collegeLocatorServiceInitAppServer) Send(m *InitResponse) error {
